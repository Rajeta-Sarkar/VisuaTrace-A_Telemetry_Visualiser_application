package com.example.visuatrace_atelemetryvisualiserapplication;
            ...
            public void onClick(View view) {
                ...
                reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        a.setText(speed);
                        String accelaration =
                                dataSnapshot.child("Acceleration").getValue().toString();
                        b.setText(accelaration);
                        String range = dataSnapshot.child("Range").getValue().toString();
                        c.setText(range);
                        String batt_vol =
                                dataSnapshot.child("AccumulatorSoC").getValue().toString();
                        d.setText(batt_vol);
                    }
                    @Override
